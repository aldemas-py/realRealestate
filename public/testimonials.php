 ...
 * TESTIMONIALS PAGE
 */
$pageTitle = 'Testimonials - FlexiSpace';
...
$testimonials = $db->query("
    SELECT t.*, u.full_name, os.name as space_name
    FROM testimonials t 
...
<section class="section" style="padding: 40px 0;">
    <div class="container">
        ...
        <p class="section-subtitle">Real reviews from businesses and professionals who work with us.</p>
                    ...
                    <div class="testimonial-card">
                        <div class="testimonial-header">
                            ...
                            <div class="testimonial-author">
                                ...
                                <?php if ($t['space_name']): ?>
                                    <small>Works at: <?= htmlspecialchars($t['space_name']) ?></small>
                                <?php endif; ?>
                            </div>
                        ...
                        <form method="POST" action="">
                            <div class="form-group">
                                    ...
                                    <?php for ($i = 5; $i >= 1; $i--): ?>
                                        <label style="cursor: pointer;">
                                            <input type="radio" name="rating" value="<?= $i ?>" style="display: none;"
                                                onchange="this.closest('div').querySelectorAll('label').forEach((l,j)=>l.style.color=j<5-this.value?'var(--accent)':'var(--border)')">
                                            <span style="color: var(--border); transition: var(--transition);">★</span>
                                        </label>
                                    <?php endfor; ?>
                                </div>
                                <div class="form-group">
                                    <label for="space_id">Related Space (optional)</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="content" name="content" placeholder="Tell us about your experience..."
