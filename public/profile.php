...
/**
 * USER PROFILE PAGE
 * View leases, payments, visit requests, and manage personal info
 */
...
// Get user's leases
$leases = $db->prepare("
    SELECT l.*, os.name as space_name, os.address_line1, os.city
    FROM leases l 
...
// Get user's payments
$payments = $db->prepare("
    SELECT p.*, os.name as space_name 
    FROM payments p 
...
$visits = $db->prepare("
    SELECT vr.*, os.name as space_name 
...
$pageTitle = 'My Profile - FlexiSpace';
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-card">
                                ...
                                <?php if (!empty($leases)): ?>
                                    <h3 style="margin: 24px 0 16px;">Recent Leases</h3>
                                    <div class="table-responsive">
                                        <table>
                                            ...
                                            <tbody>
                                                <?php foreach (array_slice($leases, 0, 5) as $l): ?>
                                                    <tr>
                            ...
                            <div class="tab-content" id="leases">
                                ...
                                <?php if (empty($leases)): ?>
                                    <p style="color: var(--text-light); padding: 40px 0; text-align: center;">No leases yet.
                                        Browse spaces and request a visit to get started.</p>
                                <?php else: ?>
                                    <div class="table-responsive">
                                        <table>
                                            <thead>
                            ...
                            <div class="tab-content" id="payments">
                                ...
                                <?php if (empty($payments)): ?>
                                    <p style="color: var(--text-light); padding: 40px 0; text-align: center;">No payment
                                        records found.</p>
                                <?php else: ?>
                                    <div class="table-responsive">
                                        <table>
                            ...
                            <div class="tab-content" id="visits">
                                ...
                                <?php if (empty($visits)): ?>
                                    <p style="color: var(--text-light); padding: 40px 0; text-align: center;">No visit
                                ...
                                <div style="max-width: 500px;">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small style="color: var(--text-light);">Email cannot be changed. Contact
                                                admin for assistance.</small>
                                        </div>
                                        <div class="form-group">
