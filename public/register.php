...
/**
 * REGISTER PAGE - Account Creation Request
 * Policy: New accounts start as 'pending' until admin approval
 */
    ...
    if (empty($errors)) {
        try {
            ...
            if ($stmt->fetch()) {
                ...
                // Policy: default role is 'customer' (role_id = 2), status 'pending'
                $stmt = $db->prepare("
                ...
                $_SESSION['success'] = 'Account created successfully! Your account is pending admin approval. You will be notified once approved.';
...
$pageTitle = 'Create Account - FlexiSpace';
...
<section class="auth-page">
    <div class="auth-card">
        ...
        <p>Register for a FlexiSpace account. Approval required to access rentals.</p>
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="password" id="password" name="password" placeholder="Min 8 chars, upper, lower, number"
                    required>
            </div>
            <div class="form-group">
